...
module.exports = class IconfontPlugin {
  ...
  getBinder(compiler, event) {
    return compiler.hooks ? compiler.hooks[event].tapAsync.bind(compiler.hooks[event], "webpackIconfontPluginNodejs") : compiler.plugin.bind(compiler, event);
  }
